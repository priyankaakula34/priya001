 ...
 * @author priya
 */
public class ViewPatientsDataJPanel extends javax.swing.JPanel {

    /**
     * Creates form ViewPatientDataJPanel
     */
    public ViewPatientsDataJPanel() {
        initComponents();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        for (Patient patient : map.keySet()) {
            if (Integer.parseInt(txtPatientIdSearch.getText()) == patient.getPatientId()) {
                ...
                txtCommunityId.setText(String.valueOf(comm.getId()));
                txtCommunityName.setText(comm.getName());
                txthouseId.setText(comm.getHouseCode());
